...
public class ConfigTableModel extends AbstractTableModel{
	...
	public ConfigTableModel(){
		...
		configEntries.add(new ConfigEntry("Auto_Append_Hosts_To_Exclude_Scope", ".*.baidu.com,.*.google.com",ConfigEntry.Config_Basic_Variable,false,false,"Auto Append This Hosts to Exclusion Scope On Startup"));
